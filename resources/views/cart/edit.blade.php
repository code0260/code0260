                ...
                <div id="specifications-container">
                    @foreach ($item->options['specifications'] as $index => $specification)
                        <div class="specification-item mb-3" data-index="{{ $index }}">
                            ...
                            <input type="text" name="specifications[{{ $index }}][name]" class="form-control"
                            ...
                            <textarea name="specifications[{{ $index }}][paragraphs]" class="ckeditor form-control" rows="3">
                            ...
                            <input type="file" name="specifications[{{ $index }}][images][]" class="form-control"
                                multiple
